package net.myerichsen.gen.mvp.preferences;
...
import net.myerichsen.gen.mvp.dialogs.ServerListDialog;
...
public class ServerPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void propertyChange(PropertyChangeEvent event) {
		new ScopedPreferenceStore(InstanceScope.INSTANCE, "net.myerichsen.gen.mvp");
