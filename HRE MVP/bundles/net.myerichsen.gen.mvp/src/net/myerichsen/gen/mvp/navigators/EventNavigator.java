...
public class EventNavigator {
	...
	public void createControls(Composite parent, EMenuService menuService) {
		...
		menuService.registerContextMenu(tableViewer.getControl(), "net.myerichsen.gen.mvp.popupmenu.eventmenu");
	...
	protected void openEventView() {
		String contributionURI = "bundleclass://net.myerichsen.gen.mvp/net.myerichsen.gen.mvp.parts.EventView";
...
// FIXME Opening a second window titled "Event"
		...
		eventBroker.post(net.myerichsen.gen.mvp.Constants.EVENT_PID_UPDATE_TOPIC, eventPid);
