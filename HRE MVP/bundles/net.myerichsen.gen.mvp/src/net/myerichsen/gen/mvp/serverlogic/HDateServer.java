...
import net.myerichsen.gen.mvp.dbmodels.Hdates;

/**
 * Business logic interface for {@link net.myerichsen.gen.mvp.dbmodels.HDates}
 *
...
public class HDateServer {
	...
	public List<String> get() throws SQLException, MvpException {
		...
		List<Hdates> hdateList = date.get();

		for (Hdates hdate : hdateList) {
