...
import net.myerichsen.gen.mvp.providers.LocationNameMapProvider;
...
public class LocationNameMapView {
	...
	public void createControls(Composite parent) {
		...
		Label lblLocationStyle = new Label(parent, SWT.NONE);
		...
		Label lblLabelReportPosition = new Label(parent, SWT.NONE);
