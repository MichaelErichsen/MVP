...
public class LocationNameStyleView {
	...
	protected void openLocationNameMapView() {
		...
		final ParameterizedCommand command = commandService
				.createCommand("net.myerichsen.gen.mvp.command.openlocationnamemapview", null);
		...
		eventBroker.post(net.myerichsen.gen.mvp.Constants.LOCATION_NAME_MAP_PID_UPDATE_TOPIC, nameMapPid);
	}
