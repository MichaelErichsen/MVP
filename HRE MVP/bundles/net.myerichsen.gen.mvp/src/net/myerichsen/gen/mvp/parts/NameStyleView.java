...
import net.myerichsen.gen.mvp.dbmodels.NameMaps;
import net.myerichsen.gen.mvp.providers.NameStyleProvider;
...
public class NameStyleView {
	...
	protected void openNameMapView() {
		...
		final ParameterizedCommand command = commandService
				.createCommand("net.myerichsen.gen.mvp.command.opennamemapview", null);
		...
		eventBroker.post(net.myerichsen.gen.mvp.Constants.NAME_MAP_PID_UPDATE_TOPIC, nameMapPid);
	}
