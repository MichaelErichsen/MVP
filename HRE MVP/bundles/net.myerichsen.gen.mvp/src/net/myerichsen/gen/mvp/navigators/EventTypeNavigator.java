...
public class EventTypeNavigator {
	...
	public void createControls(Composite parent, EMenuService menuService) {
		...
		menuService.registerContextMenu(tableViewer.getControl(), "net.myerichsen.gen.mvp.popupmenu.eventtypemenu");
		...
		TableColumn tblclmnEventType = tableViewerColumn_1.getColumn();
	...
	protected void openEventTypeView() {
		String contributionURI = "bundleclass://net.myerichsen.gen.mvp/net.myerichsen.gen.mvp.parts.EventTypeView";
		...
		eventBroker.post(net.myerichsen.gen.mvp.Constants.EVENT_TYPE_PID_UPDATE_TOPIC, eventTypePid);
