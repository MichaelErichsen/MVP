...
import net.myerichsen.gen.mvp.providers.PersonProvider;
...
public class PersonView {
	...
	public void createControls(Composite parent) {
		...
		Label lblBirthDate = new Label(parent, SWT.NONE);
		...
		Label lblDeathDate = new Label(parent, SWT.NONE);
		...
		Label lblNames = new Label(parent, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnNameId = new TableViewerColumn(tableViewerNames, SWT.NONE);
		TableColumn tblclmnNameId = tableViewerColumnNameId.getColumn();
		tblclmnNameId.setWidth(100);
		tblclmnNameId.setText("ID");

		TableViewerColumn tableViewerColumnNameLabel = new TableViewerColumn(tableViewerNames, SWT.NONE);
		TableColumn tblclmnName = tableViewerColumnNameLabel.getColumn();
		tblclmnName.setWidth(250);
		tblclmnName.setText("Name");

		TableViewerColumn tableViewerColumnNamePrimary = new TableViewerColumn(tableViewerNames, SWT.NONE);
		TableColumn tblclmnNamePrimary = tableViewerColumnNamePrimary.getColumn();
		tblclmnNamePrimary.setWidth(83);
		tblclmnNamePrimary.setText("Primary");

		Label lblSex = new Label(parent, SWT.NONE);
		lblSex.setText("Sex\r\nDblclk to open");
		...
		TableViewerColumn tableViewerColumnSexId = new TableViewerColumn(tableViewerSex, SWT.NONE);
		TableColumn tblclmnSexId = tableViewerColumnSexId.getColumn();
		tblclmnSexId.setWidth(100);
		tblclmnSexId.setText("ID");

		TableViewerColumn tableViewerColumnSexLabel = new TableViewerColumn(tableViewerSex, SWT.NONE);
		TableColumn tblclmnSex = tableViewerColumnSexLabel.getColumn();
		tblclmnSex.setWidth(250);
		tblclmnSex.setText("Sex");

		TableViewerColumn tableViewerColumnSexPrimary = new TableViewerColumn(tableViewerSex, SWT.NONE);
		TableColumn tblclmnSexPrimary = tableViewerColumnSexPrimary.getColumn();
		tblclmnSexPrimary.setWidth(83);
		tblclmnSexPrimary.setText("Primary");

		Label lblPartners = new Label(parent, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnPartnersId = new TableViewerColumn(tableViewerPartners, SWT.NONE);
		TableColumn tblclmnPartnersId = tableViewerColumnPartnersId.getColumn();
		tblclmnPartnersId.setWidth(100);
		tblclmnPartnersId.setText("ID");

		TableViewerColumn tableViewerColumnPartnersLabel = new TableViewerColumn(tableViewerPartners, SWT.NONE);
		TableColumn tblclmnPartners = tableViewerColumnPartnersLabel.getColumn();
		tblclmnPartners.setWidth(250);
		tblclmnPartners.setText("Partners");

		TableViewerColumn tableViewerColumnRole = new TableViewerColumn(tableViewerPartners, SWT.NONE);
		TableColumn tblclmnPartnerRole = tableViewerColumnRole.getColumn();
		tblclmnPartnerRole.setWidth(100);
		tblclmnPartnerRole.setText("Role");

		TableViewerColumn tableViewerColumnPartnersPrimary = new TableViewerColumn(tableViewerPartners, SWT.NONE);
		TableColumn tblclmnPartnersPrimary = tableViewerColumnPartnersPrimary.getColumn();
		tblclmnPartnersPrimary.setWidth(73);
		tblclmnPartnersPrimary.setText("Primary");

		Label lblParents = new Label(parent, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnParentsId = new TableViewerColumn(tableViewerParents, SWT.NONE);
		TableColumn tblclmnParentsId = tableViewerColumnParentsId.getColumn();
		tblclmnParentsId.setWidth(100);
		tblclmnParentsId.setText("ID");

		TableViewerColumn tableViewerColumnParentsLabel = new TableViewerColumn(tableViewerParents, SWT.NONE);
		TableColumn tblclmnParents = tableViewerColumnParentsLabel.getColumn();
		tblclmnParents.setWidth(250);
		tblclmnParents.setText("Parents");

		TableViewerColumn tableViewerColumn = new TableViewerColumn(tableViewerParents, SWT.NONE);
		TableColumn tblclmnParentRole = tableViewerColumn.getColumn();
		tblclmnParentRole.setWidth(100);
		tblclmnParentRole.setText("Role");

		TableViewerColumn tableViewerColumnParentsPrimary = new TableViewerColumn(tableViewerParents, SWT.NONE);
		TableColumn tblclmnParentsPrimary = tableViewerColumnParentsPrimary.getColumn();
		tblclmnParentsPrimary.setWidth(73);
		tblclmnParentsPrimary.setText("Primary");

		Label lblChildren = new Label(parent, SWT.NONE);
		...
		TableViewerColumn tableViewerColumn_1 = new TableViewerColumn(tableViewerChildren, SWT.NONE);
		TableColumn tblclmnChildrenId = tableViewerColumn_1.getColumn();
		tblclmnChildrenId.setWidth(100);
		tblclmnChildrenId.setText("ID");

		TableViewerColumn tableViewerColumn_2 = new TableViewerColumn(tableViewerChildren, SWT.NONE);
		TableColumn tblclmnChildren = tableViewerColumn_2.getColumn();
		tblclmnChildren.setWidth(250);
		tblclmnChildren.setText("Children");

		Label lblEvents = new Label(parent, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnEventId = new TableViewerColumn(tableViewerEvents, SWT.NONE);
		TableColumn tblclmnId = tableViewerColumnEventId.getColumn();
		tblclmnId.setWidth(100);
		tblclmnId.setText("ID");

		TableViewerColumn tableViewerColumnEventLabel = new TableViewerColumn(tableViewerEvents, SWT.NONE);
		TableColumn tblclmnEvent = tableViewerColumnEventLabel.getColumn();
		tblclmnEvent.setWidth(100);
		tblclmnEvent.setText("Event");

		TableViewerColumn tableViewerColumnEventRole = new TableViewerColumn(tableViewerEvents, SWT.NONE);
		TableColumn tblclmnRole = tableViewerColumnEventRole.getColumn();
		tblclmnRole.setWidth(100);
		tblclmnRole.setText("Role");

		TableViewerColumn tableViewerColumnFromDate = new TableViewerColumn(tableViewerEvents, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnToDate = new TableViewerColumn(tableViewerEvents, SWT.NONE);
	...
	private void get(int key) {
		try {
			...
			List<List<String>> sexesList = provider.getSexesList();

			for (int i = 0; i < sexesList.size(); i++) {
				TableItem item = new TableItem(tableSex, SWT.NONE);
				ls = sexesList.get(i);
				item.setText(0, ls.get(0));
				item.setText(1, ls.get(1));
				item.setText(2, ls.get(2));
			...
			List<List<String>> partnersList = provider.getPartnerList();

			for (int i = 0; i < partnersList.size(); i++) {
				TableItem item = new TableItem(tablePartners, SWT.NONE);
			...
			List<List<String>> parentsList = provider.getParentList();

			for (int i = 0; i < parentsList.size(); i++) {
				TableItem item = new TableItem(tableParents, SWT.NONE);
			...
			List<List<String>> childrenList = provider.getChildrenList();

			for (int i = 0; i < childrenList.size(); i++) {
				TableItem item = new TableItem(tableChildren, SWT.NONE);
				ls = childrenList.get(i);
				item.setText(0, ls.get(0));
				item.setText(1, ls.get(1));
			}

			List<List<String>> eventsList = provider.getEventList();
	...
	protected void openEventView() {
		...
		final ParameterizedCommand command = commandService
				.createCommand("net.myerichsen.gen.mvp.command.openeventview", null);
		handlerService.executeHandler(command);
	...
	protected void openNameView() {
		...
		final ParameterizedCommand command = commandService.createCommand("net.myerichsen.gen.mvp.command.opennameview",
				null);
		handlerService.executeHandler(command);
	...
	protected void openSexView() {
		...
		final ParameterizedCommand command = commandService.createCommand("net.myerichsen.gen.mvp.command.opensexview",
				null);
		handlerService.executeHandler(command);
