package net.myerichsen.gen.mvp.requesthandlers;
...
import net.myerichsen.gen.mvp.HreContextHandlerCollection;
...
public class ProjectStartEmbeddedServerHandler {
	...
	IPreferenceStore store = new ScopedPreferenceStore(InstanceScope.INSTANCE, "net.myerichsen.gen.mvp");
