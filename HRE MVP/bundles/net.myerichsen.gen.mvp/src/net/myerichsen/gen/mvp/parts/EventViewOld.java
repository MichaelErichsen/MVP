...
import net.myerichsen.gen.mvp.providers.EventProvider;
...
public class EventViewOld {
	...
	public void createControls(Composite parent, IEclipseContext context) {
		...
		Composite compositeFrom = new Composite(parent, SWT.NONE);
		...
		Composite compositeTo = new Composite(parent, SWT.NONE);
		...
		Label lblPersons = new Label(parent, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnPersonId = new TableViewerColumn(tableViewerPersons, SWT.NONE);
		TableColumn tblclmnId = tableViewerColumnPersonId.getColumn();
		tblclmnId.setWidth(50);
		tblclmnId.setText("ID");

		TableViewerColumn tableViewerColumnPersonName = new TableViewerColumn(tableViewerPersons, SWT.NONE);
		TableColumn tblclmnName = tableViewerColumnPersonName.getColumn();
		tblclmnName.setWidth(200);
		tblclmnName.setText("Name");

		TableViewerColumn tableViewerColumnPersonRole = new TableViewerColumn(tableViewerPersons, SWT.NONE);
		TableColumn tblclmnRole = tableViewerColumnPersonRole.getColumn();
		tblclmnRole.setWidth(100);
		tblclmnRole.setText("Role");

		Label lblLocations = new Label(parent, SWT.NONE);
		...
		TableViewerColumn tableViewerColumnLocationId = new TableViewerColumn(tableViewerLocations, SWT.NONE);
		TableColumn tblclmnLocationId = tableViewerColumnLocationId.getColumn();
		tblclmnLocationId.setWidth(50);
		tblclmnLocationId.setText("ID");

		TableViewerColumn tableViewerColumnLocationName = new TableViewerColumn(tableViewerLocations, SWT.NONE);
		TableColumn tblclmnLocation = tableViewerColumnLocationName.getColumn();
...
//			textLabel.setText(provider.getLabel());
			...
			List<List<String>> personList = provider.getPersonList();
			List<String> ls;

			for (int i = 0; i < personList.size(); i++) {
				TableItem item = new TableItem(tablePersons, SWT.NONE);
				ls = personList.get(i);
			...
			List<List<String>> locationList = provider.getLocationList();

			for (int i = 0; i < locationList.size(); i++) {
				TableItem item = new TableItem(tableLocations, SWT.NONE);
...
//			provider.setLabel(textLabel.getText());
	...
	protected void openLocationView() {
		...
		final ParameterizedCommand command = commandService
				.createCommand("net.myerichsen.gen.mvp.command.openlocationview", null);
