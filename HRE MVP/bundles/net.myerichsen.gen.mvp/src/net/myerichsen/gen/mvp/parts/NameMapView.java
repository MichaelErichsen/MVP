...
import net.myerichsen.gen.mvp.providers.NameMapProvider;
...
public class NameMapView {
	...
	private NameMapProvider provider;
	 ...
	 */
	public NameMapView() throws SQLException {
		provider = new NameMapProvider();
	}
	...
	public void createControls(Composite parent) {
		...
		Label lblStyle = new Label(parent, SWT.NONE);
