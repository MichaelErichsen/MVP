...
public class LocationNavigator {
	...
	public void createControls(Composite parent, EMenuService menuService) {
		...
		menuService.registerContextMenu(tableViewer.getControl(), "net.myerichsen.gen.mvp.popupmenu.locationmenu");
	...
	protected void openLocationView() {
		String contributionURI = "bundleclass://net.myerichsen.gen.mvp/net.myerichsen.gen.mvp.parts.LocationView";
		...
		eventBroker.post(net.myerichsen.gen.mvp.Constants.LOCATION_PID_UPDATE_TOPIC, locationPid);
