...
import net.myerichsen.gen.mvp.providers.LocationPersonProvider;
...
public class LocationPersonView {
	...
	public void createControls(Composite parent) {
		...
		TableColumn tblclmnPerson = tableViewerColumnEventLabel.getColumn();
	...
	private void get(int key) {
		try {
			...
			List<String> nameList = provider.getPersonList(key);
	...
	protected void openPersonView() {
		String contributionURI = "bundleclass://net.myerichsen.gen.mvp/net.myerichsen.gen.mvp.parts.PersonView";
