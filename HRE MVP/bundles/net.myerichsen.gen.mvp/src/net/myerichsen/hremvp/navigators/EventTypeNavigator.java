...
import net.myerichsen.hremvp.providers.EventTypeProvider;
...
public class EventTypeNavigator {
	...
	protected void openEventTypeView() {
		String contributionURI = "bundleclass://net.myerichsen.hremvp/net.myerichsen.hremvp.parts.EventTypeView";
