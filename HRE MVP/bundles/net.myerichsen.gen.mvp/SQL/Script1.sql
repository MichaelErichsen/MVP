...
CREATE INDEX SEX_TYPES_SEXES_FK_INDEX_9 ON SEXES (SEX_TYPE_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_7 ON LANGUAGES (LANGUAGE_PID ASC);
...
CREATE INDEX CONSTRAINT_30_INDEX_6 ON NAME_STYLES (LANGUAGE_PID ASC);

CREATE INDEX PERSONS_SEXES_FK_INDEX_9 ON SEXES (PERSON_PID ASC);
...
CREATE INDEX NAME_STYLES_NAMES_FK_INDEX_7 ON NAMES (NAME_STYLE_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_410 ON LOCATIONS (LOCATION_PID ASC);

CREATE UNIQUE INDEX PRIMARY_KEY_36 ON SEX_TYPES (SEX_TYPE_PID ASC);

CREATE UNIQUE INDEX PRIMARY_KEY_FD ON EVENTS (EVENT_PID ASC);

CREATE UNIQUE INDEX PRIMARY_KEY_A7 ON NAME_PARTS (NAME_PART_PID ASC);

CREATE INDEX PERSONS_NAMES_FK_INDEX_7 ON NAMES (PERSON_PID ASC);

CREATE INDEX PERSONS_PARTNERS_FK_INDEX_2 ON PARTNERS (PARTNER1 ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_1F ON PERSON_EVENTS (PERSON_EVENT_PID ASC);
...
CREATE INDEX PERSONS_PARTNERS_FK1_INDEX_2 ON PARTNERS (PARTNER2 ASC);

CREATE UNIQUE INDEX PRIMARY_KEY_8 ON LOCATION_NAME_MAPS (LOCATION_NAME_MAP_PID ASC);

CREATE UNIQUE INDEX PRIMARY_KEY_94B ON SEXES (SEXES_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_6A ON PERSONS (PERSON_PID ASC);

CREATE UNIQUE INDEX PRIMARY_KEY_2 ON PARTNERS (PARTNER_PID ASC);
...
CREATE INDEX LANGUAGES_SEX_TYPES_FK_INDEX_E ON SEX_TYPES (LANGUAGE_PID ASC);

CREATE INDEX CONSTRAINT_INDEX_B ON LOCATION_NAME_PARTS (LOCATION_NAME_PID ASC);

CREATE UNIQUE INDEX PERSONS_SEXES_FK_INDEX_6 ON PERSONS (PERSON_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_4 ON PARENTS (PARENT_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_796 ON NAMES (NAME_PID ASC);
...
ALTER TABLE NAMES ADD CONSTRAINT PRIMARY_KEY_796 UNIQUE (NAME_PID);
...
ALTER TABLE PERSONS ADD CONSTRAINT PERSONS_SEXES_FK_INDEX_6 UNIQUE (PERSON_PID);

ALTER TABLE LANGUAGES ADD CONSTRAINT PRIMARY_KEY_7 UNIQUE (LANGUAGE_PID);

ALTER TABLE EVENTS ADD CONSTRAINT PRIMARY_KEY_FD UNIQUE (EVENT_PID);
...
ALTER TABLE SEX_TYPES ADD CONSTRAINT LANGUAGES_SEX_TYPES_FK FOREIGN KEY (LANGUAGE_PID)
	REFERENCES LANGUAGES (LANGUAGE_PID)
	ON DELETE RESTRICT
	ON UPDATE RESTRICT;
...
ALTER TABLE LOCATION_NAME_STYLES ADD CONSTRAINT LANGUAGES_LOCATION_NAME_STYLES_FK FOREIGN KEY (LANGUAGE_PID)
	REFERENCES LANGUAGES (LANGUAGE_PID)
	ON DELETE RESTRICT
	ON UPDATE RESTRICT;
