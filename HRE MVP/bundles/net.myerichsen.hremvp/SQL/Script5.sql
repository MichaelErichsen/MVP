...
CREATE UNIQUE INDEX PRIMARY_KEY_D ON EVENT_NAMES (EVENT_NAME_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_7 ON PARTNERS (PARTNER_PID ASC);
...
ALTER TABLE EVENTS ADD CONSTRAINT PRIMARY_KEY_7A UNIQUE (EVENT_PID);
...
ALTER TABLE LOCATION_NAME_STYLES ADD CONSTRAINT PRIMARY_KEY_37 UNIQUE (LOCATION_NAME_STYLE_PID);
...
ALTER TABLE LOCATION_NAME_MAPS ADD CONSTRAINT CONSTRAINT_8 FOREIGN KEY (LOCATION_NAME_STYLE_PID)
