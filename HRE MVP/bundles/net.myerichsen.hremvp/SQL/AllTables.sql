...
CREATE UNIQUE INDEX PRIMARY_KEY_D16F7923_0 ON EVENT_NAMES (EVENT_NAME_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_4A94943_0 ON PERSON_EVENTS (PERSON_EVENT_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_7A9AD5 ON EVENTS (EVENT_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_7A9AD51 ON EVENTS (EVENT_PID ASC);
...
CREATE UNIQUE INDEX PRIMARY_KEY_D16F792 ON EVENT_NAMES (EVENT_NAME_PID ASC);

CREATE UNIQUE INDEX PRIMARY_KEY_6CEEF6D6_0 ON LOCATION_NAME_PARTS (LOCATION_NAME_PART_PID ASC);

CREATE UNIQUE INDEX PRIMARY_KEY_4A9494 ON PERSON_EVENTS (PERSON_EVENT_PID ASC);
...
ALTER TABLE USERIDS ADD CONSTRAINT PRIMARY_KEY_795 UNIQUE (USERID_PID);
...
ALTER TABLE EVENTS ADD CONSTRAINT PRIMARY_KEY_7A9A UNIQUE (EVENT_PID);

ALTER TABLE PERSON_NAMES ADD CONSTRAINT PRIMARY_KEY_AE07 UNIQUE (NAME_PID);
...
ALTER TABLE PERSONS ADD CONSTRAINT PRIMARY_KEY_25B5B UNIQUE (PERSON_PID);
...
ALTER TABLE HDATES ADD CONSTRAINT PRIMARY_KEY_7EB9FB1 UNIQUE (HDATE_PID);

ALTER TABLE LOCATION_NAME_STYLES ADD CONSTRAINT LOCATION_NAME_STYLES_PK PRIMARY KEY (LOCATION_NAME_STYLE_PID);

ALTER TABLE LOCATIONS ADD CONSTRAINT PRIMARY_KEY_5EBC673 UNIQUE (LOCATION_PID);
...
ALTER TABLE LOCATION_NAME_STYLES ADD CONSTRAINT PRIMARY_KEY_371D3B8 UNIQUE (LOCATION_NAME_STYLE_PID);
...
ALTER TABLE PERSON_NAME_STYLES ADD CONSTRAINT PRIMARY_KEY_F8FBCB UNIQUE (NAME_STYLE_PID);
