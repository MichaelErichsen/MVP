...
public class TMG9ProjectWizardPage extends WizardPage {
	...
	public TMG9ProjectWizardPage() {
		...
		setImageDescriptor(ResourceManager.getPluginImageDescriptor(
				"org.historyresearchenvironment.usergui", "icons/TMG163.png"));
	...
	public void createControl(final Composite parent) {
		...
		this.textProject.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				if (!TMG9ProjectWizardPage.this.textProject.getText()
						.isEmpty()) {
		...
		this.btnBrowse.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				TMG9ProjectWizardPage.this.textProject
						.setText(TMG9ProjectWizardPage.this.project);
				TMG9ProjectWizardPage.this.name = FilenameUtils
						.getBaseName(TMG9ProjectWizardPage.this.project)
						.replace("_", "");
				TMG9ProjectWizardPage.LOGGER
						.info("Project: " + TMG9ProjectWizardPage.this.project);
			}
		});
		...
		this.lblHDatabaseName
				.setFont(SWTResourceManager.getFont("Segoe UI", 12, 0));
		...
		this.btnSelect.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				TMG9ProjectWizardPage.this.textDbname
						.setText(TMG9ProjectWizardPage.this.dbName);
				TMG9ProjectWizardPage.this.dbName = TMG9ProjectWizardPage.this.dbName
						.replace(".h2.db", "");
				TMG9ProjectWizardPage.LOGGER
						.info("Database; " + TMG9ProjectWizardPage.this.dbName);
				TMG9ProjectWizardPage.this.setPageComplete(true);
