...
import net.myerichsen.hremvp.project.servers.ChildRoleServer;
 ...
 *
 */
public class ChildRoleProvider implements IHREProvider {
	private int ChildRolePid;
	private String Abbreviation;
	private final ChildRoleServer server;

	/**
	 * Constructor
	 *
	 */
	public ChildRoleProvider() {
		server = new ChildRoleServer();
	}
...
//	}
	...
	public void update() throws Exception {
		server.setEventRolePid(ChildRolePid);
		server.setAbbreviation(Abbreviation);
		server.update();
	}
