...
public class ProjectNewDatabaseServer {
	...
	private final String[] statementArray = {
			...
			"CREATE TABLE PARTNER_ROLES ( PARTNER_ROLE_PID INTEGER NOT NULL, ABBREVIATION CHAR(8) NOT NULL, LABEL_PID INTEGER NOT NULL, INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 26 NOT NULL );",
