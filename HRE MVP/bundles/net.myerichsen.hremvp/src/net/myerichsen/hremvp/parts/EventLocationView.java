...
public class EventLocationView {
	...
	public void createControls(Composite parent) {
		...
		TableColumn tblclmnLocation = tableViewerColumnEventLabel.getColumn();
	...
	private void get(int key) {
		try {
			...
			List<String> nameList = provider.getLocationList(key);
	...
	protected void openLocationView() {
		String contributionURI = "bundleclass://net.myerichsen.hremvp/net.myerichsen.hremvp.parts.LocationViewOld";
		...
		eventBroker.post(Constants.LOCATION_PID_UPDATE_TOPIC, Integer.parseInt(LocationPid));
