...
public class NewLocationNameWizardPage1 extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		btnCopyFromTo.addMouseListener(new MouseAdapter() {
			...
			public void mouseDown(MouseEvent e) {
				wizard = (NewLocationNameWizard) getWizard();
				wizard.setFromDatePid(wizard.getToDatePid());
	...
	public String getComboLocationNameStyle() {
		final IStructuredSelection structuredSelection = comboViewerLocationNameStyles
				.getStructuredSelection();
		final List<String> ls = (List<String>) structuredSelection
				.getFirstElement();
		return ls.get(0);
	}
