...
public class HelpAboutDialog extends Dialog {
	...
	protected void createButtonsForButtonBar(Composite parent) {
		...
		final Button button = createButton(parent, Constants.LICENSES_ID, "Licenses", true);
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblLogo.setImage(ResourceManager.getPluginImage("net.myerichsen.hremvp", "icons/HRE1.0Logo.png"));
		lblLogo.setText("");
