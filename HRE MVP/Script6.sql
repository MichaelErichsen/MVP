...
CREATE INDEX DICTIONARY_PERSON_NAME_STYLES_FK_INDEX_F ON PERSON_NAME_STYLES (LABEL_PID ASC);
...
CREATE INDEX DICTIONARY_LOCATION_NAME_STYLES_FK_INDEX_3 ON LOCATION_NAME_STYLES (LABEL_PID ASC);
...
CREATE INDEX DICTIONARY_PERSON_NAME_MAPS_FK_INDEX_B ON PERSON_NAME_MAPS (LABEL_PID ASC);
...
CREATE UNIQUE INDEX LANGUAGES_DICTIONARY_FK_INDEX_9 ON LANGUAGES (ISOCODE ASC);

CREATE INDEX DICTIONARY_LOCATION_NAME_MAPS_FK_INDEX_8 ON LOCATION_NAME_MAPS (LABEL_PID ASC);
...
CREATE INDEX DICTIONARY_EVENT_TYPES_FK_INDEX_D ON EVENT_TYPES (LABEL_PID ASC);
...
ALTER TABLE PERSON_NAME_MAPS ADD CONSTRAINT DICTIONARY_PERSON_NAME_MAPS_FK FOREIGN KEY (LABEL_PID)
...
ALTER TABLE LOCATION_NAME_MAPS ADD CONSTRAINT DICTIONARY_LOCATION_NAME_MAPS_FK FOREIGN KEY (LABEL_PID)
	REFERENCES DICTIONARY (LABEL_PID)
	ON DELETE RESTRICT
	ON UPDATE RESTRICT;
...
ALTER TABLE LOCATION_NAME_STYLES ADD CONSTRAINT DICTIONARY_LOCATION_NAME_STYLES_FK FOREIGN KEY (LABEL_PID)
	REFERENCES DICTIONARY (LABEL_PID)
	ON DELETE RESTRICT
	ON UPDATE RESTRICT;
...
ALTER TABLE EVENT_TYPES ADD CONSTRAINT DICTIONARY_EVENT_TYPES_FK FOREIGN KEY (LABEL_PID)
	REFERENCES DICTIONARY (LABEL_PID)
	ON DELETE RESTRICT
	ON UPDATE RESTRICT;
...
ALTER TABLE PERSON_NAME_STYLES ADD CONSTRAINT DICTIONARY_PERSON_NAME_STYLES_FK FOREIGN KEY (LABEL_PID)
	REFERENCES DICTIONARY (LABEL_PID)
	ON DELETE RESTRICT
	ON UPDATE RESTRICT;
