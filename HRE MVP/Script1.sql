...
--		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 17 NOT NULL,
...
CREATE TABLE PERSONS (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 15 NOT NULL,
...
CREATE TABLE PERSON_NAME_MAPS (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 13 NOT NULL
	);
...
CREATE TABLE LANGUAGES (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 7 NOT NULL
	);
...
CREATE TABLE PERSON_EVENTS (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 2 NOT NULL,
...
CREATE TABLE COMMIT_LOGS (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 19 NOT NULL
	);

CREATE TABLE USERIDS (
		USERID_PID INTEGER NOT NULL,
		PERSON_PID INTEGER NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 20 NOT NULL
	);
...
CREATE TABLE PARTNERS (
		...
		ROLE VARCHAR(2147483647) NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 5 NOT NULL,
...
CREATE TABLE LOCATION_NAMES (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 8 NOT NULL,
		FROM_DATE_PID INTEGER,
		TO_DATE_PID INTEGER
	);
...
CREATE TABLE SEXES (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 11 NOT NULL,
		FROM_DATE_PID INTEGER,
		TO_DATE_PID INTEGER
	);
...
CREATE TABLE EVENTS (
		EVENT_PID INTEGER NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 12 NOT NULL,
		FROM_DATE_PID INTEGER,
		TO_DATE_PID INTEGER,
		EVENT_NAME_PID INTEGER NOT NULL
	);
...
CREATE TABLE EVENT_TYPES (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 23 NOT NULL,
		LABEL_PID INTEGER NOT NULL
	);
...
CREATE TABLE LOCATION_NAME_STYLES (
		LOCATION_NAME_STYLE_PID INTEGER NOT NULL,
		LABEL_PID INTEGER NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 16 NOT NULL,
		FROM_DATE_PID INTEGER,
		TO_DATE_PID INTEGER
	);
...
CREATE TABLE LOCATION_NAME_PARTS (
		...
		LABEL VARCHAR(2147483647) NOT NULL,
		PART_NO INTEGER NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 18 NOT NULL
	);

CREATE TABLE HDATES (
		HDATE_PID INTEGER NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 3 NOT NULL,
...
CREATE TABLE PARENTS (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 22 NOT NULL,
		LANGUAGE_PID INTEGER
	);
...
CREATE TABLE PERSON_NAMES (
		...
		NAME_STYLE_PID INTEGER NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 10 NOT NULL,
		FROM_DATE_PID INTEGER,
		TO_DATE_PID INTEGER
	);
...
CREATE TABLE LOCATIONS (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 9 NOT NULL,
		FROM_DATE_PID INTEGER,
		TO_DATE_PID INTEGER
	);
...
CREATE TABLE SEX_TYPES (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 1 NOT NULL,
		LABEL_PID INTEGER NOT NULL
	);
...
CREATE TABLE LOCATION_NAME_MAPS (
		...
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 21 NOT NULL,
		LABEL_PID INTEGER NOT NULL
	);
...
CREATE TABLE PERSON_NAME_STYLES (
		NAME_STYLE_PID INTEGER NOT NULL,
		LABEL_PID INTEGER NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 14 NOT NULL
	);
...
CREATE TABLE LOCATION_EVENTS (
		...
		PRIMARY_EVENT BOOLEAN NOT NULL,
		PRIMARY_LOCATION BOOLEAN NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 4 NOT NULL
	);
...
CREATE TABLE DICTIONARY (
		...
		LABEL VARCHAR(2147483647) NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 6 NOT NULL,
...
CREATE TABLE PERSON_NAME_PARTS (
		...
		PART_NO INTEGER NOT NULL,
		INSERT_TSTMP TIMESTAMP NOT NULL, UPDATE_TSTMP  TIMESTAMP NOT NULL, TABLE_ID INTEGER DEFAULT 24 NOT NULL
	);
...
ALTER TABLE LOCATION_NAMES ADD CONSTRAINT PRIMARY_KEY_BC9C UNIQUE (LOCATION_NAME_PID);
...
ALTER TABLE USERIDS ADD CONSTRAINT PRIMARY_KEY_220 UNIQUE (USERID_PID);

ALTER TABLE EVENTS ADD CONSTRAINT PRIMARY_KEY_7A9 UNIQUE (EVENT_PID);
