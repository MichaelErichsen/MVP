...
/*    */     
/* 23 */     EventAssociatesProvider model = new EventAssociatesProvider();
/* 24 */     s = parts[(parts.length - 1)];
/* 25 */     model.setId(Integer.parseInt(s));
/*    */     
/* 27 */     ServerRequest request = new ServerRequest(t.getRequestMethod(), "eventassociates", model);
/* 28 */     SomeBusinessLogic sbl = new SomeBusinessLogic(request);
/* 29 */     ServerResponse response = sbl.doSomethingWithRequest();
/*    */     
/* 31 */     model = (EventAssociatesProvider)response.getProvider();
/*    */     
...
/* Location:              C:\Temp\HRE Mockup Product-win32.win32.x86_64\plugins\org.historyresearchenvironment.usergui_1.0.0.201801161825.jar!\org\historyresearchenvironment\usergui\serverinterface\AssociatesModelHandler.class
